...
class MagicSquareGrid {
    ...
    public static int diagonalSum(int grid[][], int r,int c){
        ...
        int sum2 = grid[r+2][c]+grid[r+1][c+1]+grid[r][c+2];
        if(sum1 == sum2){
            return sum1;
        }
        return -1;
    }
    public static boolean magicSum(int grid[][], int r, int c){
        ...
        if(rowSum == colSum && rowSum == diagonalSum) return true;
        return false;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total Number of Possible 3 * 3 matrix can be formed form a given matrix of grid is : "+res);
    }
}
